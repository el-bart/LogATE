...
auto makeLongLine()
{
  const auto loremIpsum = std::string{
        ...
        "ipsum, quia dolor sit amet consectetur adipiscing velit, sed quia non-numquam do eius modi tempora incididunt, ut labore et dolore "
        "magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrumd exercitationem ullam corporis suscipit laboriosam, nisi ut "
        ...
        "quas molestias excepturi sint, obcaecati cupiditate non-provident, similique sunt in culpa, qui officia deserunt mollitia animi, id est "
...
int main()
{
  ...
  CursATE::Screen::multiLinePreview( makeLongLine() );
}
